                            ...
                            <form method="POST" action="{{ route('reservations.store.step.two') }}">
                                ...
                                <div class="mt-6 p-4 flex justify-between">
                                    <a href="{{ route('reservations.step.one') }}"
                                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Revenir</a>
                                    <button type="submit"
                                        class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Faites la reservation</button>
                                </div>
                            </form>
                        </div>
                    </div>
